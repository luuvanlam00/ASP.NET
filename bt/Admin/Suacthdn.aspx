<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="Suacthdn.aspx.cs" Inherits="bt.Admin.Suacthdn" %>
                       ...
                       <div class="ibox-content">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group"><label class="col-sm-2 control-label">Mã hóa đơn nhập</label>
                                    ...
                                    <div class="col-sm-10">
                                        <asp:TextBox runat="server" ID="txtma"  CssClass="form-control" required=""></asp:TextBox>
                                     </div>
                                </div>
