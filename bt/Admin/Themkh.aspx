<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="Themkh.aspx.cs" Inherits="bt.Admin.Themkh1" %>
                       ...
                       <div class="ibox-content">
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Email</label>
                                    ...
                                    <div class="col-sm-10">
                                        <asp:TextBox runat="server" TextMode="Email" ID="txtem" CssClass="form-control" required=""></asp:TextBox>
                                     </div>
                                </div>
                                <div class="hr-line-dashed"></div>
