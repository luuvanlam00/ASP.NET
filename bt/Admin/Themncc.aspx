<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site1.Master" AutoEventWireup="true" CodeBehind="Themncc.aspx.cs" Inherits="bt.Admin.CTncc" %>
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 col-sm-offset-2">
                                      ...
                                      <button class="btn btn-white" type="submit" ><a href="Ncc.aspx">Quay lại</a></button>
                                    </div>
                                </div>
                            </div>
                        </div>
